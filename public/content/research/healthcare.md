...
**How chargemasters work:**
- Set internally by hospital revenue cycle / finance departments (VP Revenue Cycle or CFO). No external authority regulates them.
- Exist as negotiating anchors: commercial insurers negotiate discounts off chargemaster. Higher chargemaster = higher absolute contract value even at the same discount percentage.
- Uninsured patients historically billed at chargemaster in full.
- Charity care write-offs calculated at gross (chargemaster) rates for IRS Form 990 Schedule H reporting — not at cost. This inflates the reported community benefit figure. Permitted by IRS.

**Real line-item prices (documented):**
- Aspirin 325mg: $28/tablet at Stamford Hospital CT (2013, Brill). $47 in our 2031 documents is conservative — inflating at 5–7%/yr from $28 brings it to $55–70 by 2031.
- Normal saline 1L: wholesale cost ~$1. Chargemaster: $100–$700. Vox (2018) found some California hospitals billing $546/liter.
- Blood count (CBC): ~$11 Medicare rate, $157 chargemaster (Brill).
- Chest X-ray: ~$20 Medicare rate, $283 chargemaster (Brill).
- System-wide cost-to-charge ratio for high-markup hospitals: 0.10–0.21 (i.e., costs are 10–21 cents per dollar billed).
- Chargemaster to Medicare ratio: typically 3:1 to 6:1; top 50 markup hospitals averaged 10.1x Medicare (Bai & Anderson, 2015).

**Charity care and gross charge rates:**
- IRS Form 990 Schedule H: nonprofits report charity care at charges, not cost. Inflates the number.
- GAO documented this in 2006: "Hospitals generally report uncompensated care at charges... since charges typically exceed costs, reporting uncompensated care at charges overstates the actual resource cost."
- Senate Finance Committee (Grassley, 2013) investigated nonprofits abusing this.

**Key sources:**
- Steven Brill, "Bitter Pill: Why Medical Bills Are Killing Us," *Time*, February 20, 2013. The foundational journalism piece with verbatim chargemaster line items.
- Ge Bai & Gerard F. Anderson, "Extreme Markup: The Fifty US Hospitals With The Highest Chargemaster Markups," *Health Affairs*, vol. 34 no. 6, May 2015. https://www.healthaffairs.org/doi/10.1377/hlthaff.2015.0183
...
- Anderson, Reinhardt, Hussey & Petrosyan, "It's The Prices, Stupid," *Health Affairs*, vol. 22 no. 3, 2003.
- CMS Hospital Price Transparency Final Rule, 85 Fed. Reg. 65524 (Oct. 16, 2020).
- Elisabeth Rosenthal, *An American Sickness*, Penguin Press, 2017.

---

## EOB Language and Insurance Framing

**Standard EOB columns:**
- Amount Billed: chargemaster price
- Negotiated Discount ("Your Savings"): difference between billed and contracted rate. Framed as benefit to member. Member had no role in negotiating and "saved" nothing — the chargemaster rate was never real money at risk.
- Allowed Amount: contracted rate. What insurer agreed to pay + member cost-share.
- Plan Paid: what insurer actually paid.
- Your Responsibility: deductible, copay, coinsurance.

**The "savings" framing:**
Standard practice at UnitedHealth, Anthem/BCBS, Cigna, Aetna. "YOUR PLAN SAVED YOU $X" is industry-standard language. The "savings" is the difference from a chargemaster price the patient never had access to. Not addressed by the No Surprises Act.

**Out-of-network providers the patient didn't choose:**
Anesthesiologists, radiologists, pathologists, hospitalists. Before NSA: EOB would show "Non-Participating Provider" with OON cost-sharing, no notation that patient had no choice. NSA (effective 2022) changed cost-sharing to in-network level for these providers at in-network facilities — but EOB still shows OON status. The determination is based on whether the individual physician/group has a separate contract with the insurer, independent of the hospital contract.

**No Surprises Act (effective January 1, 2022) — what it covers:**
- Emergency services at any facility: patient pays in-network cost-sharing.
- Non-emergency at in-network facilities from OON providers patient didn't choose (anesthesiologist/radiologist scenario): patient pays in-network cost-sharing.
- Air ambulance from OON carriers.
- Cost-sharing based on Qualifying Payment Amount (QPA) — typically median in-network rate.

**No Surprises Act — what it explicitly does NOT cover:**
- **Ground ambulance**. Largest carve-out. Explicitly excluded because ambulance services are often provided by local governments and Congress couldn't resolve political complexity. Federal advisory committee was created to study it. As of 2024, no federal ground ambulance protections.
- The IDR process was overwhelmed — 490,000+ disputes filed by late 2023 vs. ~17,000/yr projected. Insurers used it to dispute large numbers of small claims.
- *Texas Medical Association v. HHS* (No. 6:22-cv-00372, E.D. Tex. 2022) invalidated parts of IDR regulations that gave too much weight to QPA — gave providers more arbitration leverage.

**Statistics:**
- 1 in 5 emergency room visits involved OON provider charge before NSA (KFF, 2020).
- Average surprise bill in emergency settings: $1,219 (Peterson-KFF, 2020).
- Roughly 2/3 of insured adults had received a surprise medical bill (Commonwealth Fund).

**Key sources:**
- KFF Health System Tracker, "Surprise Billing" briefs (2020–2023). https://www.healthsystemtracker.org
- GAO-23-105765, "Patients Are Still at Risk for Surprise Bills in Some Situations," 2022. https://www.gao.gov/products/gao-23-105765
- CRS R47067, "Ground Ambulance and Patient Billing," 2022. https://crsreports.congress.gov/product/pdf/R/R47067
...
- 0–90 days: internal billing, 2–3 cycles.
- 90–180 days: placed with collections agency on contingency (agency keeps 25–40% of recovery). Original creditor still owns debt. "First-party placement / soft collections."
- 180 days–2 years: debt sold as portfolio for 1–15 cents on dollar for medical debt (lower than credit card debt). Original creditor paid and done.
- Accounts can pass through 3–5 buyers. Each pays less. Why people get called about old debts from unknown companies.

**Ground ambulance in collections:**
- Ground ambulance explicitly excluded from No Surprises Act. Private ambulance companies routinely bill OON with no network discount.
- Patients don't choose their ambulance. 911 dispatch sends whoever is closest/on rotation.
- Ambulance bill arrives 60–120 days after hospital matter is resolved — patients often don't expect it.
- Typical ground ALS transport: $1,800–$4,500 billed. Patient often owes $500–$3,000 after partial OON insurance payment.

**FDCPA requirements (15 U.S.C. § 1692g):**
First written communication must contain within 5 days:
1. Amount of debt
2. Name of creditor
3. 30-day window to dispute (if no dispute, assumed valid)
4. If disputed in writing within 30 days, collector will obtain verification and mail it
5. If requested in writing within 30 days, collector will provide original creditor name/address

Mini-Miranda (§ 1692e(11)): "This is an attempt to collect a debt, and any information obtained will be used for that purpose." Required on every communication.

CFPB Regulation F (12 CFR Part 1006, effective November 2021): first major FDCPA update since 1977. Adds itemization date requirement, model validation notice form.

**Real collections letter voice:**
Flat. Bureaucratic precision. No emotional language. Careful not to threaten arrest (§ 1692e(4), illegal) or make false representations.
- "This account has been referred to our office for collection."
- "Stopping contact does not eliminate the debt." (Real and exact-sounding.)
- First letter will reference original creditor name and original account number — FDCPA requires this. Readers often confused why they get a letter from a company they don't recognize about a debt from a company they barely remember.

**Statistics:**
- ~100 million Americans carry some form of medical/dental debt (KFF, 2022).
- $88 billion in medical debt in collections on credit reports (CFPB, 2022).
- 58% of all debt collection tradelines on credit reports are medical (CFPB, 2022).
- Median medical debt in collections: ~$690 (CFPB, 2022).
- Medical debt is leading cause of personal bankruptcy in the US (Himmelstein et al., AJPH, 2019).

**Key sources:**
- 15 U.S.C. § 1692g (FDCPA validation notice). https://www.law.cornell.edu/uscode/text/15/1692g
- 12 CFR Part 1006 (CFPB Regulation F), effective November 30, 2021.
