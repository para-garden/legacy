...
Dates of Service:      February 24–26, 2032
```
...
Because you chose an **in-network provider**, BlueCross Advantage Select was able to negotiate a significantly lower rate on your behalf. You are not responsible for the difference between what the provider billed and our negotiated rate.
...
**Claim Number:** BCX-2032-03-887741-A
**Claim Type:** Inpatient Facility
**Network Status:** IN-NETWORK

| Service Date | Procedure | Billed | Negotiated Rate | Allowed | Plan Paid | Your Share | Reason |
|---|---|---|---|---|---|---|---|
| 02/24/2032 | Emergency Department Visit — Level 5 (99285) | $3,840.00 | −$2,531.00 | $1,309.00 | $1,309.00 | $0.00 | Deductible met prior to this line |
...
*This section summarizes how your benefits were applied. For full accumulator history, log in to your member portal or call Member Services.*

| Accumulator | Plan Year Limit | Applied This Claim | Applied Prior Claims | Total Used | Remaining |
|---|---|---|---|---|---|
| Individual Deductible | $1,500.00 | $0.00 | $1,500.00 | $1,500.00 | $0.00 |
| Individual Out-of-Pocket Maximum | $8,500.00 | $4,247.00 | $1,203.00 | $5,450.00 | $3,050.00 |
...
## ADDITIONAL CLAIMS ASSOCIATED WITH THIS EPISODE OF CARE

The following providers typically bill **separately** from the hospital. You may receive bills from these providers directly. These are not errors — they reflect standard billing practice.

---

### Anesthesiology Services — CLAIM PENDING

**Provider:** Pinnacle Anesthesia Partners, LLC
**Claim Number:** None on file
**Status:** In process. Expected processing window: 30–45 business days from date of service.
...
>
> **Step 2:** If the provider is found to be out-of-network and you dispute the bill, you or the provider may initiate the **Independent Dispute Resolution (IDR) process** through the federal portal at cms.gov/idr. Note: The IDR process is available to **providers and insurers**, not directly to members. Member disputes follow the internal appeals process below.
>
> **Step 3:** If you receive a bill from this provider before your claim is processed, **do not pay it yet.** Contact Member Services. Paying a bill before your claim is processed may affect your ability to dispute the balance.
>
> We will send you a separate EOB when this claim is processed.

---

### Radiologist Services — CLAIM PENDING

**Provider:** Radiology Partners National Group
**Claim Number:** None on file
**Status:** Not yet received. You may receive a bill directly from this provider.
...
**Provider:** Regional Pathology Associates
**Claim Number:** None on file
**Status:** Not yet received. Specimen pathology is routinely processed 3–6 weeks after discharge. You may receive a bill directly from this provider.

---

### Surgeon Professional Fee — CLAIM PENDING

**Provider:** To be determined
**Claim Number:** None on file
**Status:** Not yet received. The surgeon's professional fee is billed separately from the facility fee already processed above. Network status for the treating surgeon has not yet been confirmed. Please retain all Explanation of Benefits documents you receive related to this hospitalization.

---

### Emergency Transportation — NO CLAIM RECEIVED

**Provider:** METS — Metro Emergency Transport Services
**Claim Number:** None on file
...
>
>    > BlueCross Advantage Select — Member Reimbursement
>    > P.O. Box 91488
>    > Phoenix, AZ 85068-1488
>
>    Fax: 1-888-204-3371 (cover sheet required; do not send originals by fax)
>
> 5. **Retain all original documents.** Submissions received without all required documentation will be returned unprocessed. The resubmission clock does not reset upon return.
> 6. **Deadline:** Manual reimbursement requests must be received within **90 days of the date of service** (February 24, 2032). Requests received after May 24, 2032 will not be eligible for reimbursement regardless of circumstance, except in cases of documented incapacity (supporting documentation required).
>
...
This Explanation of Benefits is a summary of how BlueCross Advantage Select processed your claim. It is not a bill. Here's what each column means:

**Amount Billed:** The amount your provider charged. This is the starting point.

**Negotiated Discount:** The reduction in cost made possible by your provider's participation in the BlueCross Advantage Select network. This amount has been adjusted from your bill automatically — you do not owe this portion, and your provider has agreed not to bill you for it. This is one of the key benefits of using in-network providers.
...
**Reason Codes:** Codes that explain how each service line was processed. A complete list of reason codes is available at bluecrossadvantageselect.com/reasoncodes or by calling Member Services.

> If after reading this explanation you are still unsure how your benefits were applied, or if the amounts on this EOB differ from a bill you have received, please call Member Services. Our team is here to help you understand your benefits.

---

## YOUR NEXT STEPS

- [ ] Review the amounts listed under "Your Share" above. You may receive a bill from Ascend Health System for **$4,247.00.** This is the correct amount per your plan.
- [ ] Watch for additional EOBs for anesthesiology, radiology, pathology, and surgery. Do not pay any provider bill until you have received the corresponding EOB.
- [ ] If you receive a bill from METS, read the emergency transportation section above before paying.
...
You have the right to appeal this decision. BlueCross Advantage Select is committed to a fair and transparent appeals process.

**Internal Appeal**

If you believe a claim was processed incorrectly, or that a benefit was improperly denied or reduced, you may file an internal appeal. Appeals must be submitted in writing within **180 days of the date of this EOB.** Verbal requests do not initiate the appeals process. Your written request must include: your name, Member ID, claim number(s) at issue, a description of the specific determination you are disputing, and any supporting documentation (medical records, provider statements, etc.) you wish to have considered. Submit appeals to:

> BlueCross Advantage Select — Appeals & Grievances Unit
> P.O. Box 91501
> Phoenix, AZ 85068-1501
> Fax: 1-888-204-3388
...
*This Explanation of Benefits is a summary only. Benefits are governed by your Certificate of Coverage, Schedule of Benefits, and any applicable riders or amendments. In the event of a conflict between this EOB and your plan documents, the plan documents control. BlueCross Advantage Select reserves the right to recover any overpayments made on your behalf. This document is not a guarantee of payment; claims are subject to audit and adjustment. BlueCross Health Partners, Inc. is an independent licensee of the BlueCross BlueShield Association. BlueCross Advantage Select is not affiliated with the federal Medicare or Medicaid programs. Prior authorization requirements, network status, and benefit limits are subject to change. Please verify eligibility and benefits prior to each episode of care at bluecrossadvantageselect.com/verify or by calling Member Services.*

*To view your full Summary of Benefits and Coverage (SBC), Evidence of Coverage (EOC), or Certificate of Coverage, log in to your member portal. Paper copies are available upon request within 7 business days; call Member Services.*

*Language assistance services are available free of charge. Call 1-800-422-2583 (TTY: 711). Servicios de idiomas disponibles sin cargo. 免費提供語言協助服務。 언어 지원 서비스는 무료로 제공됩니다。*

*Form BCX-EOB-2031-R4 | March 2032*
*BlueCross Health Partners, Inc. | Phoenix, AZ 85068*
